...
import {
  SettingsForm,
  setNpmCDNRegistry,
} from '@liukefu/designable-react-settings-form'
import {
  createDesigner,
  GlobalRegistry,
  Shortcut,
      ...
      <StudioPanel logo={<LogoWidget />} actions={<ActionsWidget />}>
        <CompositePanel>
          <CompositePanel.Item title="panels.Component" icon="Component">
            <ResourceWidget title="sources.Inputs" sources={inputSources} />
            <ResourceWidget title="sources.Layouts" sources={layoutsSources} />
            <ResourceWidget
